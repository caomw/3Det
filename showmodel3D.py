...
#model=util.load("/users/visics/mpederso/code/git/3Def/3Det/data/VOC3Def/bus1_Debug0.model")[0]
#model=util.load("/users/visics/mpederso/code/git/3Def/3Det/data/VOC3Def/bicycle1_New2Debug_final.model")[0]
#model=util.load("/users/visics/mpederso/code/git/3Def/3Det/data/NEW/VOC3Def/bicycle1_Good_final.model")[0]
#if 'models' in locals():
#    print "Using local model"
#    model=models[0]
#else:
#    model=util.load("/users/visics/mpederso/code/git/3Def/3Det/data/NEW/AFLW/face1_AFLW2000Fixed_final.model")[0]
#model=util.load("/users/visics/mpederso/code/git/3Def/3Det/data/epfl/car1_DebugEPFL0.model")[0]
#model=util.load("/users/visics/mpederso/code/git/3Def/3Det/data/VOC3Def/bicycle1_DiffAspect2.model")[0]
